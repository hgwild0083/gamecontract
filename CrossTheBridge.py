...
Admin = Base58ToAddress('AHEVPJWCBRfc8BM3rjFZSi5TBXzAwQKUYs')
ctx = GetContext()
...
def Main(operation, args):
	...
	if operation == 'takeItem':
		return takeItem(args[0],args[1])
...
def takeItem(domain,itemId):
    Put(GetContext(),domain,itemId)
    Notify(['takeItem', domain, itemId])
    return True